...
if platform.system() in ['Linux', 'FreeBSD', 'DragonFly']:
    ...
    data_files += [
        (os.path.join('share', 'applications'),               ['electrum-yottaflux.desktop']),
...
setup(
    ...
    scripts=['electrum/electrum_yottaflux'],
    data_files=data_files,
    description="Lightweight Yottaflux Wallet",
    author="Thomas Voegtlin",
    author_email="thomasv@electrum.org",
    license="MIT Licence",
    url="https://electrum.org",
    long_description="""Lightweight Yottaflux Wallet""",
)
