...
class UpdateCheck(QDialog, Logger):
    url = "https://raw.githubusercontent.com/yottaflux/electrum-yai/master/check-version.json"
    download_url = "https://github.com/yottaflux/electrum-yai/releases"

    VERSION_ANNOUNCEMENT_SIGNING_KEYS = (
        "RPuQNvDVBC5Q4fXKyfYLjrunbyqiEYckP5",  # kralverde signing key
    )
