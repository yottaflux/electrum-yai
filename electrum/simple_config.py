...
class SimpleConfig(Logger):
    ...
    BLOCK_EXPLORER = ConfigVar('block_explorer', default='explorer.yottaflux.ai', type_=str)
    ...
    WIZARD_DONT_CREATE_SEGWIT = ConfigVar('nosegwit', default=True, type_=bool) # no segwit for YAI
