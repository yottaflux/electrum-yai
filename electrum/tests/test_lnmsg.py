...
class TestLNMsg(ElectrumTestCase):
    ...
    def test_encode_decode_msg__missing_mandatory_field_gets_set_to_zeroes(self):
        ...
        self.assertEqual(bfh(""),
                         encode_msg(
                             "channel_update",
        ...
        self.assertEqual(('channel_update',
                         {'chain_hash': b'I\x1c\xea\xc5L\xff R63\x07\xcc<u,\xa7}t;{th\x8d\x83\x9c\x0f\xd5\x9fp\x00\x00\x00',
                          'channel_flags': b'\x00',
                          'cltv_expiry_delta': 144,
                          'fee_base_msat': 500,
                          'fee_proportional_millionths': 35,
                         ...
                         decode_msg(bfh("")))
    ...
    def test_encode_decode_msg__init(self):
        ...
        self.assertEqual(bfh("00100000000220c20120491ceac54cff2052363307cc3c752ca77d743b7b74688d839c0fd59f70000000"),
                         encode_msg(
                             "init",
                             gflen=0,
                             flen=2,
                             ...
                             init_tlvs={
                                 'networks':
                                     {'chains': b'I\x1c\xea\xc5L\xff R63\x07\xcc<u,\xa7}t;{th\x8d\x83\x9c\x0f\xd5\x9fp\x00\x00\x00'}
                             }
                         ))
        ...
        self.assertEqual(('init',
                         ...
                         decode_msg(bfh("001000022200000302aaa20120491ceac54cff2052363307cc3c752ca77d743b7b74688d839c0fd59f70000000")))
